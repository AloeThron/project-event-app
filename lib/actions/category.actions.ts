...
// ใช้ในการดึงข้อมูลทั้งหมดของหมวดหมู่สินค้าที่มีอยู่ในฐานข้อมูล โดยใช้ Category.find เพื่อค้นหาและคืนค่าข้อมูลทั้งหมดในฐานข้อมูลในรูปแบบ JSON
export async function getAllCategories() {
  try {
    // เชื่อมต่อกับฐานข้อมูล
    await connectToDatabase();

    // ทำการดึงข้อมูลหมวดหมู่ (categories) จากฐานข้อมูลโดยใช้ Category.find() ซึ่งน่าจะเป็นการค้นหาข้อมูลทั้งหมดของตารางหรือคอลเลกชันที่เก็บข้อมูลของหมวดหมู่นั้นๆ
